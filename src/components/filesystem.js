 ...
 * │ type          │ "note" | "image" | "pdf" | "upload" | "shortcut"        │
 ...
 * │ storageUrl    │ string | null   (Firebase Storage URL for uploads)       │
 * │ createdAt     │ Timestamp                                                │
 * │ updatedAt     │ Timestamp                                                │
 * └───────────────┴──────────────────────────────────────────────────────────┘
 *
...
/**
 * Delete a folder and all its direct files.
 * For nested folders call this recursively.
 */
...
/**
 * Create a new file (note, shortcut, etc.)
 * @param {string}      uid
 * @param {object}      payload   { name, type, folderId, content, mimeType, storageUrl }
